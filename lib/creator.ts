const supportEmail = process.env.NEXT_PUBLIC_SUPPORT_EMAIL?.trim() || 'support@cvflow.com';
...
export const SUPPORT_INFO = {
  teamName: process.env.NEXT_PUBLIC_SUPPORT_TEAM_NAME?.trim() || 'CVFlow Support',
  role: process.env.NEXT_PUBLIC_SUPPORT_ROLE?.trim() || 'Chăm sóc khách hàng',
  email: supportEmail,
  phone: supportPhone,
  supportHours:
    process.env.NEXT_PUBLIC_SUPPORT_HOURS?.trim() || 'Thứ 2 - Thứ 7, 08:00 - 22:00 (GMT+7)',
  message:

...
export const TEMPLATES: Omit<Template, 'createdAt'>[] = [
    ...
    },
    {
      ...
      descriptionVi: 'Màu teal tươi sáng, nhấn mạnh kỹ năng và hoạt động ngoại khóa',
    ...
    },
    {
      ...
      descriptionVi: 'Header gradient toàn bộ mặt, bố cục 2 cột hiện đại cao cấp',
    ...
    },
    {
      ...
      descriptionVi: 'Sidebar tràn viền, icon tùy chỉnh, bố cục kiểu portfolio cho designer',
